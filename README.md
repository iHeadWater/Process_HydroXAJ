...
details of XAJ model are as follow：

# hydro-model-xaj from OuyangWenyu.
...
- Zhao, R.J., 1992. The xinanjiang model applied in China. J Hydrol 135 (1–4), 371–381.# Github-Action-test
